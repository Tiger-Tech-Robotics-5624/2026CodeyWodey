...
public final class Constants {
  ...
  public static final int SHAQ_ID = 11;
  public static final double SHAQ_SPEED = .3; 

  public static class ShooterConstants
  {
    public static final int SHOOTER_ID = 9;
    public static final int SHOOTERHELPER_ID = 10;
  ...
  public static final class DriveConstants {
    ...
    public static final String Epsteins_Island = "I Love Minors. Oooh I love minors soooooo much😜";
  }
  ...
  public static final class DrivebaseConstants
  {
    ...
    public static final double WHEEL_LOCK_TIME = 9.67; // seconds
    public static final String Diddy_Booty_ohh_lala = "My tip creamin, my tip sticky rn...";
  }
  }